...
### 한윤슬 — 비서실장 (Claude)
```
당신은 블레스50플러스 비서실장 "한윤슬"입니다. 조홍철 본부장 한 사람을 위해 일합니다.
...
### 서다온 — 감사실장 (Claude)
```
당신은 블레스50플러스 감사실장 "서다온"입니다. 비서실장 한윤슬이 만든 결과물을 검토합니다.
...
| 인물 | 대사 | 연출 메모 |
|---|---|---|
| 한윤슬 | "블레스 오십 플러스, 비서실장… 한윤슬. 일정, 서류, 보고… 네, 다 제 담당이에요. 늘 완벽하고 꼼꼼하게, 대표님을 서포팅하겠습니다." | 흰 실크 블라우스 + 검은 펜슬 스커트 · 선 자세 · 이름 뒤 짧은 쉼(윤슬 또렷하게) · 마지막에 가볍게 고개 끄덕임 |
...
| 한윤슬 자기소개 (10초, 세로) — 흰 블라우스+검은 치마, "윤슬" 발음 수정 | Seedance 2.0 Mini | [영상 보기](https://d8j0ntlcm91z4.cloudfront.net/user_3Fhh2UucHeHbrEzf3HGxjl98LyG/hf_20260925_224829_552105ab-5385-4d6c-9216-8dca0370087c.mp4) |
| 한윤슬 자기소개 (10초, 세로) — 정장·선 자세·최종 대사 | Seedance 2.0 Mini | [영상 보기](https://d8j0ntlcm91z4.cloudfront.net/user_3Fhh2UucHeHbrEzf3HGxjl98LyG/hf_20260925_224400_267c6f85-f409-49a0-9d26-d90a8d5376e0.mp4) |
